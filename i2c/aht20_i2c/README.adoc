= Attaching a aht20 temp/humidity sensor via I2C

This example code shows how to interface the Raspberry Pi Pico with the AHT20 temperature and humidity sensor manufactured by AOSONG.
